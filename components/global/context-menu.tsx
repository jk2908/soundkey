...
export function Item({
  ...
  return (
    <button
      ...
      role="menuitem"
      className={cn(
        'cursor-default text-start font-mono text-xs text-app-fg-inverted hover:bg-highlight focus-visible:bg-highlight focus-visible:text-white focus-visible:outline-none group-aria-[orientation=horizontal]:px-4 group-aria-[orientation=horizontal]:py-4 group-aria-[orientation=vertical]:px-4 group-aria-[orientation=vertical]:py-2',
        className
      )}
      {...rest}>
      {children}
